...
## How To Test
 ...
 - Start Google Play on the device using the campaign link. Your link should look something like this 
 
Testing Url : Dummy Facebook App Install Campaign 
```Link
...
- Get decryption key from your facebook developer account.
   Here is [guide to get decryption key](https://developers.facebook.com/docs/app-ads/install-referrer/)  
